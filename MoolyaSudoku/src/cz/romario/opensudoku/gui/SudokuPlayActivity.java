...
public class SudokuPlayActivity extends Activity {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		menu.add(0, MENU_ITEM_UNDO, 0, R.string.undo).setShortcut('1', 'u')
		...
		menu.add(0, MENU_ITEM_HELP, 1, R.string.help).setShortcut('0', 'h')
		...
		menu.add(0, MENU_ITEM_UNDO_TO_CHECKPOINT, 2,
	...
	public boolean onPrepareOptionsMenu(Menu menu) {
		...
		if (mSudokuGame.getState() == SudokuGame.GAME_STATE_PLAYING) {
			...
			menu.findItem(MENU_ITEM_UNDO).setEnabled(
					mSudokuGame.hasSomethingToUndo());
			menu.findItem(MENU_ITEM_UNDO_TO_CHECKPOINT).setEnabled(
					mSudokuGame.hasUndoCheckpoint());
		} else {
